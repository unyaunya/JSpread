...
public class JSpread extends JComponent implements CellEditorListener {
	...
	public JSpread() {
		...
		//this.selectionModel = new SingleRangeSelectionModel();
		this.selectionModel = new MultiRangeSelectionModel();
