...
public class JSpread extends JComponent implements CellEditorListener {
	...
	public class Handler extends MouseInputAdapter implements KeyListener {
		...
		private final Cursor ROW_SELECT_CURSOR = createCursor("icons/arrow_right.gif", new Point(31, 15));
		private final Cursor COLUMN_SELECT_CURSOR = createCursor("icons/arrow_down.gif", new Point(15, 31));
